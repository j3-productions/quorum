...
export const NavBar = () => {
  ...
  // TODO: On-click of search icon perform the search; on enter as well? Tag
  // field will need to be changed.
      ...
      <div className="container-fluid w-full flex flex-wrap items-center justify-between px-6">
        ...
        <div className="rounded-md">
          <div className='relative flex items-center'>
            <SearchIcon
              onClick={() => navigate(`/search/${searchBoard}/${rawQuery}`, {replace: true})}
